                ...
                try{
                    ...
                    if(med != null){
                        if(dataOK(tf_data.getText(), med.dias)){
                            ...
                            Consulta consulta = new Consulta(tf_cliente.getText(), tf_telefone.getText(), (String)cb_medico.getValue(), tf_valor.getText(), forma_de_atendimento, tf_data.getText(), horario);
                            HomeController.consultas.add(consulta);
